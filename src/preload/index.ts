...
contextBridge.exposeInMainWorld('desktopAPI', {
  ...
  addAccounts: (args: any) => ipcRenderer.invoke('accounts:add-batch', args),
  ...
  setContentBounds: (bounds: any) => ipcRenderer.invoke('ui:set-content-bounds', bounds),
  showAccountMenu: (id: string) => ipcRenderer.invoke('ui:account-menu', id),
  readCloud: (path: string) => ipcRenderer.invoke('cloud:read', path),
  measureRoutes: () => ipcRenderer.invoke('cloud:routes'),
  saveCloudRoute: (route: string) => ipcRenderer.invoke('cloud:set-route', route),
  diagnoseConnection: () => ipcRenderer.invoke('cloud:diagnose'),
  onAccountAction: (callback: (action: any) => void) => { const fn = (_e: any, action: any) => callback(action); ipcRenderer.on('ui:account-action', fn); return () => ipcRenderer.removeListener('ui:account-action', fn) },
  ...
  getCacheInfo: () => ipcRenderer.invoke('translator:cache-info'),
  clearTranslationCache: () => ipcRenderer.invoke('translator:clear-cache'),
  ...
  translateSignalMessage: (id: string, message: any) => ipcRenderer.invoke('signal:translate-message', id, message),
  ...
  onAccountUnread: (callback: (msg: any) => void) => { const fn = (_e: any, msg: any) => callback(msg); ipcRenderer.on('accounts:unread', fn); return () => ipcRenderer.removeListener('accounts:unread', fn) },
